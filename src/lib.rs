...
pub mod _internal {
    ...
    use crate::runtime::async_support::{TaskId, generate_async_task_id as runtime_generate_task_id, get_current_async_task_id as runtime_get_task_id};
    ...
    pub fn enter_async_function(function_name: &str, task_id: TaskId) {
        ...
        if let Err(e) = crate::runtime::async_support::register_async_task(function_name, task_id, None) {
            eprintln!("[DBUG] Error registering async task: {}", e);
        }
        
        // Also log to console in development mode
        eprintln!("[DBUG] Entering async function: {} (task_id: {})", function_name, task_id);
    }
    ...
    pub fn exit_async_function(function_name: &str, task_id: TaskId) {
        ...
        // Also log to console in development mode
        eprintln!("[DBUG] Exiting async function: {} (task_id: {})", function_name, task_id);
    }
    ...
    pub fn async_break_point(file: &str, line: u32, column: u32, task_id: TaskId) {
        ...
        // Also log to console in development mode
        eprintln!("[DBUG] Async breakpoint at {}:{}:{} in {} (task_id: {})", file, line, column, current_function, task_id);
    }
}
